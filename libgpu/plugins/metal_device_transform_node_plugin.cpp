/**
 * @file metal_device_transform_node_plugin.cpp
 * @brief Metal Device Transform Node Plugin GPU acceleration support.
 *
...
/**
 * @brief Plugin create metal device transform node.
 */
