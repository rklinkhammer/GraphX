...
void WriteTraceJson(const std::filesystem::path& path,
    ...
    nlohmann::json trace = {
        ...
        {"diagnostics", {
            ...
            {"range_window_time_us", last_graph.diagnostics.stage_timings.range_window_time_us},
            {"range_compression_time_us", last_graph.diagnostics.stage_timings.range_compression_time_us},
            {"split_time_us", last_graph.diagnostics.stage_timings.split_time_us},
            {"h2d_stage_time_us", last_graph.diagnostics.stage_timings.h2d_stage_time_us},
            {"backprojection_stage_time_us", last_graph.diagnostics.stage_timings.backprojection_stage_time_us},
            {"d2h_stage_time_us", last_graph.diagnostics.stage_timings.d2h_stage_time_us},
            {"merge_stage_time_us", last_graph.diagnostics.stage_timings.merge_stage_time_us},
            {"diagnostics_sink_time_us", last_graph.diagnostics.stage_timings.diagnostics_sink_time_us},
        ...
        {"native_backend_parity", {
            ...
            {"native_backend_requested", options.native_backend},
            {"native_backend_resolved", last_graph.resolved_execution_backend == "metal"},
            {"backprojection_native_kernel_executed", last_graph.backprojection_native_kernel_executed},
        }},
        {"execution_outcome", {
