...
- Phase 7 status: complete on macOS; synthetic transfer and spectrum topology coverage now explicitly spans CPU/Metal/CUDA linear paths plus strict/allow fallback variants in the contract matrix, with no manual test-side configuration bypasses.
